(function () {
  ...
  var STR = {
    es: {
      ...
      footerTagline: " Noesis · Automatización con IA",
      ...
      portalInvoicesLead: "Descarga y estado de tus facturas emitidas por Noesis.",
    ...
    ca: {
      ...
      footerTagline: " Noesis · Automatització amb IA",
      ...
      portalInvoicesLead: "Descàrrega i estat de les teves factures emeses per Noesis.",
      portalThInvoice: "Número",
      portalThDate: "Data",
